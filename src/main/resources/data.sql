...
INSERT INTO update (id, date, reflexion_text, sequence_number, project, file_file_name) VALUES (1003, '12-6-2021', 'Duis in felis ut augue scelerisque placerat id sed sem.', 1, 1005, null);
INSERT INTO update (id, date, reflexion_text, sequence_number, project, file_file_name) VALUES (1004, '12-6-2021', 'In convallis massa risus, ut volutpat orci ultrices ac. Integer nec ligula eu purus finibus fermentum.', 1, 1005, null);
INSERT INTO update (id, date, reflexion_text, sequence_number, project, file_file_name) VALUES (1005, '12-6-2021', 'Nullam vitae sodales urna. Etiam nisi lacus, ornare in ante sit amet, congue viverra nulla. Vivamus quis lectus augue.', 2, 1001, null);
INSERT INTO update (id, date, reflexion_text, sequence_number, project, file_file_name) VALUES (1006, '12-6-2021', 'Donec vel diam fermentum, accumsan ex ut, gravida massa.', 3, 1001, null);
