...
import nl.jvb.mypaintpholio.services.ProjectUpdateService;
...
public class ProjectUpdateController {
    ...
    public ResponseEntity<List<ProjectUpdateDto>> getAllUpdatesByProject(@RequestParam(value = "projectId") Long Id) {
